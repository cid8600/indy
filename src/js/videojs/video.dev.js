...
/**
 * Displays the Current Event Logo 
 * 
 * @param {vjs.Player|Object} player
 * @param {Object=} options
 * @constructor
 */
vjs.EventLogo = vjs.Component.extend({
    init: function (player, options) {
        vjs.Component.call(this, player, options);
    }
});

vjs.EventLogo.prototype.createEl = function () {
    var el = vjs.Component.prototype.createEl.call(this, 'div', {
        className: 'vjs-logo-controls vjs-control'
    });

    this.contentEl_ = vjs.createEl('div', {
        className: 'vjs-logo-image'
    });
 ...
 * @constructor
 */
vjs.TouchButton = vjs.Button.extend();

vjs.TouchButton.prototype.createEl = function () {
    return vjs.Button.prototype.createEl.call(this, 'div', {
        className: 'vjs-touch-button'
    });
};
